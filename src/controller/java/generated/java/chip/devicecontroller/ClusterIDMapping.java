...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == LocationDetector.ID) {
            return new LocationDetector();
        }
        if (clusterId == EntityLocation.ID) {
    ...
    public static class LocationDetector implements BaseCluster {
    ...
    public static class EntityLocation implements BaseCluster {
        public static final long ID = 4294048770L;
        public long getID() {
            return ID;
        }
