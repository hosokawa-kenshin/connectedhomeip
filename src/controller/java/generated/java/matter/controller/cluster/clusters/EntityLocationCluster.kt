...
class EntityLocationCluster(
  ...
  suspend fun readIdAttribute(): String {
    ...
    requireNotNull(attributeData) { "Id attribute not found in response" }
  ...
  suspend fun writeIdAttribute(value: String, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 0u
  ...
  suspend fun subscribeIdAttribute(
    minInterval: Int,
    maxInterval: Int,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Id attribute not found in Node State update" }
  ...
  companion object {
    private val logger = Logger.getLogger(EntityLocationCluster::class.java.name)
    const val CLUSTER_ID: UInt = 4294048770u
  }
}
