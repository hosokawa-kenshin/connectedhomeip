...
NSString * MTRClusterNameForID(MTRClusterIDType clusterID)
{
    ...
    case MTRClusterIDTypeCommissionerControlID:
        ...
        break;
    case MTRClusterIDTypeLocationDetectorID:
        result = @"LocationDetector";
        break;
    case MTRClusterIDTypeEntityLocationID:
...
NSString * MTRAttributeNameForID(MTRClusterIDType clusterID, MTRAttributeIDType attributeID)
{
    ...
    case MTRClusterIDTypeLocationDetectorID:
        ...
        case MTRAttributeIDTypeClusterLocationDetectorAttributeBeaconUUIDID:
            result = @"BeaconUUID";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeDistanceID:
            result = @"Distance";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeMediatorUIDID:
            result = @"MediatorUID";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeLogEntryID:
            result = @"LogEntry";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeGeneratedCommandListID:
            result = @"GeneratedCommandList";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeAcceptedCommandListID:
            result = @"AcceptedCommandList";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeEventListID:
            result = @"EventList";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeAttributeListID:
            result = @"AttributeList";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeFeatureMapID:
            result = @"FeatureMap";
            break;

        case MTRAttributeIDTypeClusterLocationDetectorAttributeClusterRevisionID:
            result = @"ClusterRevision";
            break;
    ...
    case MTRClusterIDTypeEntityLocationID:
        ...
        case MTRAttributeIDTypeClusterEntityLocationAttributeIDID:
            result = @"ID";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeLocationID:
            result = @"Location";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeGeneratedCommandListID:
            result = @"GeneratedCommandList";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeAcceptedCommandListID:
            result = @"AcceptedCommandList";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeEventListID:
            result = @"EventList";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeAttributeListID:
            result = @"AttributeList";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeFeatureMapID:
            result = @"FeatureMap";
            break;

        case MTRAttributeIDTypeClusterEntityLocationAttributeClusterRevisionID:
            result = @"ClusterRevision";
            break;
