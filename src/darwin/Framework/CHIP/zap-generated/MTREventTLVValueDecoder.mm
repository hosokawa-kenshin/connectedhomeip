...
static id _Nullable DecodeEventPayloadForLocationDetectorCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
static id _Nullable DecodeEventPayloadForEntityLocationCluster(EventId aEventId, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
...
id _Nullable MTRDecodeEventPayload(const ConcreteEventPath & aPath, TLV::TLVReader & aReader, CHIP_ERROR * aError)
{
    ...
    case Clusters::LocationDetector::Id: {
        return DecodeEventPayloadForLocationDetectorCluster(aPath.mEventId, aReader, aError);
    }
    case Clusters::EntityLocation::Id: {
        return DecodeEventPayloadForEntityLocationCluster(aPath.mEventId, aReader, aError);
    }
